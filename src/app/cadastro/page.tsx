...
export default function Cadastro() {
  ...
  return (
    <div className="h-screen w-full flex flex-col items-center">
      ...
      <div className="h-[80vh] w-[90%] xl:w-[80%] flex flex-col xl:flex-row overflow-hidden">
        {etapa === 1 && (
          <div className="flex flex-col xl:flex-row w-full h-full">
            ...
            <div className="w-full xl:w-1/2 h-full flex items-center bg-white p-4 overflow-y-auto">
              <Etapa1
