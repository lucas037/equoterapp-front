...
export default function SessoesColaborador() {
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <div className="w-[90%] h-[80%] flex flex-col gap-4 xl:flex-row xl:justify-between">
                <div className={`${modal? 'hidden xl:block': 'flex flex-col'} w-[300px] sm:w-[42%] md:w-[34%] lg:w-[26%] xl:w-[18%] flex flex-col gap-1`}>
                ...
                {modal && 
                  <div className="w-full xl:w-[900px] h-full flex flex-col gap-1">
                ...
                {
                  modal &&
                  <div className="w-full xl:w-[400px] h-full flex-col gap-1">
                    ...
                    <div className="w-full h-full border border-1 border-black rounded-lg">
                      ...
                      <div className="ml-8 mb-4 mt-4 flex flex-col gap-2">
                        ...
                        <div className="text-[#255A59] font-bold">{dadosColaborador.nome}</div>
                        
                        <div className="text-[#8D8F8F] text-sm font-bold">CPF</div>
                        <div className="text-[#255A59] font-bold">{dadosColaborador.cpf}</div>
                        ...
                        <div className="text-[#255A59] font-bold">{dadosColaborador.telefone}</div>

                        <div className="text-[#8D8F8F] text-sm font-bold">QUANTIDADE DE SESSÕES</div>
                        <div className="text-[#255A59] font-bold">{dadosColaborador.quantidadeSessoes}</div>
                      </div>
                    </div>
                  </div>
                }
